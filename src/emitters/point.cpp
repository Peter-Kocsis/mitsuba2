...
public:
    MTS_IMPORT_BASE(Emitter, m_flags, m_medium, m_needs_sample_3)
    ...
    PointLight(const Properties &props) : Base(props) {
        if (props.has_property("position")) {
            ...
            m_position = props.point3f("position");
        }
    ...
    std::pair<Ray3f, Spectrum> sample_ray(Float time, Float wavelength_sample,
        ...
        const auto &trafo = Transform4f::translate(Vector3f(m_position));
    ...
    std::pair<DirectionSample3f, Spectrum> sample_direction(const Interaction3f &it,
        ...
        auto trafo = Transform4f::translate(Vector3f(m_position));
    ...
    void traverse(TraversalCallback *callback) override {
        ...
        callback->put_parameter("position", m_position);
    }
